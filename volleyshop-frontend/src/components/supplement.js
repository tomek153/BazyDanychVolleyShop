...
class Supplement extends Component {
    ...
    render() {
        return (
            <div className="product-tiles" style={{backgroundImage: "url("+this.props.info.image+")", backgroundPosition: "center", backgroundSize: "40%", backgroundRepeat: "no-repeat"}}>
                ...
                <div className="product-info-wrapper w3-animate-opacity-my" onClick={() => this.hideDetail(this.props.index)}>
                    <div className="product-info" style={{backgroundImage: "url("+this.props.info.image+")", backgroundPosition: "center", backgroundSize: "40%", backgroundRepeat: "no-repeat"}}>
