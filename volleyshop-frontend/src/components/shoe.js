...
class Shoe extends Component {
    ...
    changeStars(event){
        // document.getElementsByClassName("my").style.fontSize = "10px";
        event.preventDefault();
        console.log(event.target.id);
        document.getElementById('mystar').style.color = "red";
    }
        ...
        return (
            <div className="col mb-4" style={{width: '33%', float: 'left',}}>
                ...
                <div className="product-info-wrapper-my" onClick={() => this.hideDetail(this.props.index)}>
                    ...
                    <div className="product-info-my" style={{backgroundImage: 'url('+this.props.info.image+')', backgroundSize: '80%'}}></div>
