...
class Clothe extends Component {
    ...
    render() {
        return (
            <div className="product-tiles" style={{backgroundImage: "url("+this.props.info.image+")", backgroundPosition: "center", backgroundSize: "65%", backgroundRepeat: "no-repeat"}}>
                <div key="1" className="product-tiles-front" onClick={() => this.showDetail(this.props.index)}>
                    <span className="tile-name" style={{top: '250px'}}>{this.props.info.name}</span>
                </div>
                <div className="product-info-wrapper w3-animate-opacity-my" onClick={() => this.hideDetail(this.props.index)}>
                    <div className="product-info" style={{backgroundImage: "url("+this.props.info.image+")", backgroundPosition: "center", backgroundSize: "60%", backgroundRepeat: "no-repeat"}}>
                        <div className="specyfics-product-info">
                            ...
                            <span style={{fontSize: "19px"}}>Typ:</span> <i style={{color: "#444"}}>{this.props.info.type}</i><br />
